#!/usr/bin/env python3
"""Apple HK Store Pickup Monitor with Force Test Mode
"""
import datetime
import json
import os
...
def check_pickup():
    ...
    if TEST_MODE:
        print("[TEST_MODE ENABLED] Forcing test notification...")
        available_items.append("📱 **iPhone 18 Pro Max 256GB (測試通報)**\n📍 門市：IFC Mall 中環\n📦 狀態：可供取貨：明天")
